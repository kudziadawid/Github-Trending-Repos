package com.kudziadawid.advancedapplication.testutils;

import com.kudziadawid.advancedapplication.model.AdapterFactory;
import com.kudziadawid.advancedapplication.model.ZonedDateTimeAdapter;
...
public class TestUtils {
    ...
    public static <T> T loadJson(String path, Type type) {
        try {
            ...
            throw new IllegalArgumentException("Could not deserialze " + path + " into type: " + type);
        }
    }
    ...
    public static <T> T loadJson(String path, Class<T> clazz) {
        try {
            ...
            throw new IllegalArgumentException("Could not deserialze " + path + " into class: " + clazz);
        }
    }
