...
public class TrendingReposPresenterTest {
    ...
    public void reposLoaded() throws Exception {
        ...
        verify(repoRepository).getTrendingRepos();   //verifying that getTrendingRepos was called when presenter is created
    ...
    public void loadingSuccess() throws Exception {
        setUpSuccess(); //because value doesn't matter
        initializePresenter();
    ...
    @Test
    public void loadingEror() throws Exception {
